...
| SP-1 | Modo Simple | [sp/SP-1-modo-simple.md](sp/SP-1-modo-simple.md) | [ ] |
...
| Campo | Valor |
|-------|-------|
| **Último SP completado** | SP-0 |
| **Commit** | — |
| **Qué quedó hecho** | Docs: PRODUCT_PLAN + 10 archivos SP |
| **Desviaciones del plan** | — |
| **Deuda técnica** | — |
| **Smoke / build** | N/A (solo docs) |
| **Siguiente SP recomendado** | SP-1 |
