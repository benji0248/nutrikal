  ...
  return (
    <div className="min-h-dvh bg-bg text-text-primary">
      ...
      <main className="md:ml-72 relative z-10 min-h-screen">
        <header className="sticky top-0 w-full md:w-auto z-30 bg-[#f8faf1]/80 backdrop-blur-xl md:border-b md:border-border/30 safe-top no-print">
          <div className="flex items-center justify-between px-6 py-4 max-w-7xl mx-auto md:px-12 md:py-3 h-[var(--nk-header-inner)]">
